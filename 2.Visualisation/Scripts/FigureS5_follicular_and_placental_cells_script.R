...
adult <- read.table("FigureS5_follicular_and_placental_adult.csv", sep=',', header=TRUE, row.names = 1)    
d1 <- data.matrix(adult, rownames.force = TRUE)
fetal <- read.table("FigureS5_follicular_and_placental_fetal.csv", sep=',', header=TRUE, row.names = 1)    
...
#Output
png("Figure3.png", res=300, width=2500, height=1300)
