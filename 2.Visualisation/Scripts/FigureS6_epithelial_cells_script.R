...
adult <- read.table("FigureS6_epithelial_cells_adult.csv", sep=',', header=TRUE, row.names = 1)    
d1 <- data.matrix(adult, rownames.force = TRUE)
fetal <- read.table("FigureS6_epithelial_cells_fetal.csv", sep=',', header=TRUE, row.names = 1)    
...
#Output
png("FigureS6.png", res=300, width=4000, height=1700)
