...
adult <- read.table("Figure5_stromal_cells_adult.csv", sep=',', header=TRUE, row.names = 1)    #Remove if absent
...
colnames(d2)[colnames(d2) == "Stable.Angina.Pectoris"] <- "Stable Angina Pectoris"
...
#Output
png("Figure5.png", width = 11, height = 6.5, units = 'cm', res = 600)
