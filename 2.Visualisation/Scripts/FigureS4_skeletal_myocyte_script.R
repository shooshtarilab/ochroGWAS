...
adult <- read.table("FigureS4_skeletal_myocyte_adult.csv", sep=',', header=TRUE, row.names = 1)    
d1 <- data.matrix(adult, rownames.force = TRUE)
fetal <- read.table("FigureS4_skeletal_myocyte_fetal.csv", sep=',', header=TRUE, row.names = 1)    
...
#Output
png("FigureS4.png", res=300, height=1500, width=3000)
